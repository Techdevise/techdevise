...
import Blogimage1 from '../assets/Rectangle 180.png'; 
  ...
  return (
    <div className="relative w-[1189px] h-[211px] mx-auto mt-[149px]">
        <div>
            ...
            <p className="w-[1189px] h-[56px] font-Montserrat, text-[20px] font-medium opacity-100 text-[#000000] text-center mt-2">Stay informed with the latest trends, insights, and expert advice in technology, business solutions, and industry innovations. Explore our blogs for valuable knowledge and updates.</p>
        </div>
      {/* Search Bar */}
