...
const Navbar = () => {
  ...
  return (
    <nav
      className="absolute left-[120px] top-[33px] w-[1680px] h-[82px] text-white py-4 px-6 flex justify-between items-center bg-cover bg-center opacity-100"
    ...
    >
      ...
      <div className="hidden md:flex space-x-6 text-lg w-[762px] h-[24px] opacity-100">
        ...
        <div className="relative group">
          <button className="whitespace-nowrap w-[88px] h-[24px] opacity-100 text-[20px] font-medium leading-auto hover:text-gray-300">
        ...
        <div className="relative group">
          <Link
            to="/blog"
            className="w-[88px] h-[24px] opacity-100 text-[20px] font-medium leading-auto hover:text-gray-300 mr-1"
          >
            Blog
          </Link>
          <div className="absolute left-0 mt-2 w-40 bg-white text-black shadow-lg rounded-md hidden group-hover:block">
      ...
      <div className="md:hidden">
        <button onClick={() => setIsOpen(!isOpen)}>
          {/* Assuming Menu is the hamburger icon */}
