...
const ExperienceSection = () => {
  return (
    <div className="relative z-10 mx-auto mt-[50px] w-full max-w-[1670px] h-auto opacity-100 px-4 py-8">
      <div className="absolute top-1/2 right-0 transform -translate-y-1/2 rotate-89 origin-right mt-[300px] mr-40">
      ...
      <div className="flex flex-col md:flex-row gap-8 h-full">
        ...
        <div className="w-full md:w-[42%] flex flex-col">
          ...
          <div className="custom-card flex flex-col md:flex-row gap-x-8 gap-y-8">
